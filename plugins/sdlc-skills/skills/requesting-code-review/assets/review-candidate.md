...
- **Verification state identity:** `{{in checkpoint-range and integrated-result
  modes, the full revision captured with state-identity.sh --quiet --committed;
  in working-tree mode, the digest from --quiet; either way equal to Result
