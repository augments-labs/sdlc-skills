...
| `description` non-empty, ≤ 1024 chars | conforms | length check; longest is 452 |
| Body ≤ 500 lines | conforms | line check; longest is 162 (32% of ceiling) |
| Body < 5000 tokens recommended | conforms | token check; largest is ~1703 (34%) |
...
| `description` | ≤ 1024 chars | ≈ 452 chars | **fails** over 1024 |
